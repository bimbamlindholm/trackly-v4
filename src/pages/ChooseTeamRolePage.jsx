...
const roleTypes = [
  {
    accent: "cyan",
    buttonLabel: "Create a Workspace",
    description:
      "Create and manage your team workspace, invite members, set schedules, track attendance, and generate reports.",
    features: [
      "Create a new workspace",
      "Invite and manage team members",
      "Access advanced reports & analytics",
      "Manage attendance and schedules",
  ...
  {
    accent: "purple",
    buttonLabel: "Join a Workspace",
    description:
      "Join your company or team workspace using an invite link or workspace code from your admin.",
    features: [
      "Join an existing workspace",
      "Track your time and attendance",
      "View your schedule and reports",
      "Stay connected with your team",
    ],
    icon: UserRound,
    title: "Team Member / Employee",
    to: "/join-workspace",
  },
];
          ...
          <section className="mx-auto w-full max-w-7xl flex-1 px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="mx-auto mt-2 max-w-3xl text-center sm:mt-0">
              ...
              <h1 className="mt-5 text-[clamp(2.45rem,6vw,4.7rem)] font-black leading-[1.05] tracking-tight text-white">
                Who will be using
                <br />
                the <span className="gradient-text">team workspace?</span>
              </h1>
            ...
            <div className="mx-auto mt-8 grid max-w-5xl gap-6 md:grid-cols-2">
              {roleTypes.map((type) => (
                <TeamRoleCard key={type.title} {...type} />
              ))}
            </div>
...
export default ChooseTeamRolePage;
